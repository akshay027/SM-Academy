...
public class PracticeTestStartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practice_test_start);
        ...
        practiceTeststartDetails();


    }


    private void practiceTeststartDetails() {
        try {
            if (UIUtil.isInternetAvailable(this)) {
                ...
                RetrofitAPI.getInstance(this).getApi().getPracticeTeststartdetails(params, new Callback<PracticeTestStartWithDescription>() {
                    @Override
                    public void success(final PracticeTestStartWithDescription object, Response response) {
                        try {
                            if (object.getStatus().equals("success")) {
                                ...
                                descriptionView.loadData(mHtmlString, "text/html", "UTF-8");
                                ...
                                startBtn.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        if (checkPermission()) {
                                            Intent intent = new Intent(getApplicationContext(), PracticeActiveTestActivity.class);
                                            intent.putExtra("id", course_id);
                                            intent.putExtra("section_name", sectionName);
                                            intent.putExtra("readingcomponent", "Study Materials");
                                            intent.putExtra("practice_test_id", practice_test_id);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(PracticeTestStartActivity.this, new
