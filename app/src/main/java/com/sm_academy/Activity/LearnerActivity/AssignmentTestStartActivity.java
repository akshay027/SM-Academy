...
public class AssignmentTestStartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assignment_test_start);
        ...
        Log.e("practice_test_id", "practice_test_id-" + assignment_test_id);

        assignmentTeststartDetails();
    }

    private void assignmentTeststartDetails() {
        try {
            if (UIUtil.isInternetAvailable(this)) {
                ...
                RetrofitAPI.getInstance(this).getApi().getAssignmentTeststartdetails(params, new Callback<PracticeTestStartWithDescription>() {
                    @Override
                            ...
                            if (object.getStatus().equals("success")) {
                                ...
                                startBtn.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        Intent intent = new Intent(getApplicationContext(), AssignmentActiveTestActivity.class);
                                        intent.putExtra("id", course_id);
                                        intent.putExtra("section_name", sectionName);
                                        intent.putExtra("readingcomponent", "Study Materials");
                                        intent.putExtra("assignment_test_id", assignment_test_id);
